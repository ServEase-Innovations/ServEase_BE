...
// ServiceProviderLeaveMapper INSTANCE =
// Mappers.getMapper(ServiceProviderLeaveMapper.class);

// @Mapping(source = "serviceProvider.serviceproviderId", target =
// "serviceproviderId")
// @Mapping(source = "backupBy.serviceproviderId", target = "backupBy")
// ServiceProviderLeaveDTO serviceProviderLeaveToDTO(ServiceProviderLeave
// serviceProviderLeave);

// @Mapping(target = "serviceProvider", expression =
// "java(mapServiceProviderId(serviceProviderLeaveDTO.getServiceproviderId()))")
// @Mapping(target = "backupBy", expression =
// "java(mapServiceProviderId(serviceProviderLeaveDTO.getBackupBy()))")
// ServiceProviderLeave dtoToServiceProviderLeave(ServiceProviderLeaveDTO
// serviceProviderLeaveDTO);
