...
public interface ServiceProviderRequestCommentMapper {
    ...
    // void updateEntityFromDTO(ServiceProviderRequestCommentDTO dto,
    // ServiceProviderRequestComment entity);
 ...
 * @Mapper(componentModel = "spring")
 * public interface ServiceProviderRequestCommentMapper {
 * ServiceProviderRequestCommentMapper INSTANCE =
 * Mappers.getMapper(ServiceProviderRequestCommentMapper.class);
 * 
 * @Mapping(source = "serviceProviderRequest.requestId", target = "requestId")
 * ServiceProviderRequestCommentDTO toDTO(ServiceProviderRequestComment
 * serviceProviderRequestComment);
 * 
 * @Mapping(source = "requestId", target = "serviceProviderRequest.requestId")
 * ServiceProviderRequestComment toEntity(ServiceProviderRequestCommentDTO
 ...
 * 
 * default Long map(ServiceProviderRequest serviceProviderRequest) {
 * return serviceProviderRequest != null ? serviceProviderRequest.getRequestId()
 * : null;
 * }
 * 
 * }
