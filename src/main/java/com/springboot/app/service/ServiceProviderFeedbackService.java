...
// List<ServiceProviderFeedbackDTO> getAllServiceProviderFeedbackDTOs(int page,
// int size);
...
// void saveServiceProviderFeedbackDTO(ServiceProviderFeedbackDTO
// serviceProviderFeedbackDTO);

// // Update an existing ServiceProviderFeedbackDTO
// void updateServiceProviderFeedbackDTO(ServiceProviderFeedbackDTO
// serviceProviderFeedbackDTO);
