...
public class CustomerConstants {
    ...
    // public static final String GET_ALL_CUSTOMER_CONCERNS = "FROM
    // CustomerConcern";
    // public static final String GET_ALL_CUSTOMER_FEEDBACK = "FROM
    // CustomerFeedback";
    // public static final String GET_ALL_CUSTOMER_REQUESTS = "FROM
    // CustomerRequest";
    // public static final String GET_OPEN_CUSTOMER_REQUESTS = "FROM CustomerRequest
    // WHERE isResolved = 'NO'";
    // public static final String GET_POTENTIAL_CUSTOMERS = "FROM CustomerRequest
    // WHERE isPotential = 'YES'";
