...
public class ServiceProviderPayment {
    ...
    //     this.noOfDays = ChronoUnit.DAYS.between(startDate.toLocalDate(), endDate.toLocalDate());

    //     // Get the number of days in the month of the endDate
    //     int daysInMonth = endDate.toLocalDate().getMonth().length(endDate.toLocalDate().isLeapYear());
